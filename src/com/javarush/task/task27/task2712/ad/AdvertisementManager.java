...
public class AdvertisementManager {
    ...
    private void obtainOptimalVideoSet(List<Advertisement> totalList, int currentTimeSecondsLeft, long currentAmount) {
        ...
        for (Advertisement ad : tmp) {
            ...
            currentList.add(ad);
            obtainOptimalVideoSet(currentList,
                    currentTimeSecondsLeft - ad.getDuration(),
    ...
    private void displayAdvertisement() {
        ...
        optimalVideoSet.sort(this::extracted);
    ...
    private int extracted(Advertisement o1, Advertisement o2) {
